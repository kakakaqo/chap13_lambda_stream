...
interface MyFuncionalInterface{
	public abstract int max(int a, int b); // 추상 메소드
}
...
public class Lambda002 {
	public static void main(String[] args) {
		...
		MyFuncionalInterface fi; // 함수형 인터페이스 변수
		...
		/**
		 * [람다함수 - 익명 구현 객체] 
		 * - 람다 함수를 정의하면 실행시 해당 코드가 실행됨가 동시에 바로 익명 객체로 생성됨.
		...
		// return 키워들ㄹ 사용하는 경우 or 사용 안하는 경우[동일한 결과]
