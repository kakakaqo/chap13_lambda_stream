...
interface MyFunctionalInterface{
	public abstract void run(); // 유일한 추상 메소드(껍데기 메소드), 작업 지시 사항
}

/**
 * 람다식 테스트 클래스
 * - 매게 변수가 없고 return 문이 없는 람다 함수
 */
public class Lambda003 {
	...
	public static void main(String[] args) {
		...
		// [4] (람다식 사용없이 익명 구현 객체의 run()메소드 호출");
		// 익명 구현 객체
		fi = new MyFunctionalInterface() { // 인터페이스 이름(){};     익명 구현 객체 탄생
